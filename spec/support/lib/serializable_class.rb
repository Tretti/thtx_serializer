...
class SerializableClass
  ...
  xml_options namespace: :testing_testing, root_node: :thtx_serialized_node, namespace_definitions: {
  ...
  def child_nodes
    [ChildNode.new('child1', ['string1', 'string2']),
    ChildNode.new('child2', ['string1', 'string2'])]
  end
